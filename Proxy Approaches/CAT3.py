...
class QNetwork:
    def __init__(self, hidden_size, learning_rate, item_num, state_size, pretrain, model='GRU', name='DQNetwork'):
        ...
        with tf.variable_scope(self.name):
            ...
            self.output1 = tf.contrib.layers.fully_connected(self.states_hidden, 14,
                                                            activation_fn=None)  # category prediction logits
            ...
            self.category = tf.placeholder(tf.int32, [None]) # Three-step interaction category
            ...
            self.loss = tf.reduce_mean(catloss + celoss)
        ...
        with tf.Session() as sess:
            ...
            for i in range(args.epoch):
                for j in range(num_batches):
                    ...
                    categor2 = list(batch['category2'].values()) # Three-step interaction category value.
                    ...
                    #     evaluate(sess)
            print("Evaluating on Test Data... CAT3", mod, args.discount)
