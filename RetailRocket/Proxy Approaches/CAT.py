...
class QNetwork:
    def __init__(self, hidden_size, learning_rate, item_num, state_size, pretrain, model='GRU', name='DQNetwork'):
        ...
        with tf.variable_scope(self.name):
            ...
            self.category = tf.placeholder(tf.int32, [None]) # Two-step interaction category
        ...
        with tf.Session() as sess:
            ...
            for i in range(args.epoch):
                for j in range(num_batches):
                    ...
                    categor = list(batch['category'].values()) # Two-step interaction category value.
                    ...
                    #     evaluate(sess)
            print("Evaluating on Test Data... CAT", mod, args.discount)
