...
def evaluate(sess, model='GRU', test=False):
    ...
    while evaluated<len(eval_ids):
        ...
        for i in range(batch):
            ...
            evaluated+=1
        prediction, qtable=sess.run([QN_1.output2, QN_1.output1], feed_dict={QN_1.inputs: states,QN_1.len_state:len_states,QN_1.is_training:False})
        ...
        with tf.Session() as sess:
            ...
            for i in range(args.epoch):
                for j in range(num_batches):
                    ...
                    #     evaluate(sess)
            print("Evaluating on Test Data..., QV", mod)
