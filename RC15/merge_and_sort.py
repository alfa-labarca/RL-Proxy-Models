...
if __name__ == '__main__':
    ...
    merge_session.to_csv(os.path.join(data_directory, 'sampled_sessions.csv'), index = None, header=True)

    file_name = 'sampled_sessions'
    kwargs = {file_name: merge_session}
    to_pickled_df(data_directory, **kwargs)